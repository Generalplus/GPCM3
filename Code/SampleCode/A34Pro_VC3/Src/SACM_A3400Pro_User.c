  ...
  if(Vc3EffectEn !=0)
  {
    switch(Vc3Mode)
    {
      case VC3_SHIFT_PITCH_MODE:
        ...
        SACM_VC3_ShiftPitchProcess(DstBufAddr+VC3_FRAME_SIZE, DstBufAddr+VC3_FRAME_SIZE);
        break;

      case VC3_CONST_PITCH_MODE:
        SACM_VC3_ConstPitchProcess(DstBufAddr, DstBufAddr);
        SACM_VC3_ConstPitchProcess(DstBufAddr+VC3_FRAME_SIZE, DstBufAddr+VC3_FRAME_SIZE);
        break;

      case VC3_ECHO_MODE:
        SACM_VC3_EchoProcess(DstBufAddr, DstBufAddr);
        SACM_VC3_EchoProcess(DstBufAddr+VC3_FRAME_SIZE, DstBufAddr+VC3_FRAME_SIZE);
        break;
/*
