...
extern int8_t Vc3Mode;
extern short ModeCtrl;
  ...
  if (ModeCtrl != 0)
     ...
     switch(Vc3Mode)
    {
      ...
      case VC3_CONST_PITCH_MODE:
        SACM_VC3_ConstPitchProcess(DstBufAddr, DstBufAddr);
        break;
      ...
      case VC3_VM_ROBOT_EFFECT2_MODE:
        SACM_VC3_RobotEffect2(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;

      case VC3_VM_STRANGE_TONE_MODE:
        SACM_VC3_StrangeTone(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;

      case VC3_VM_DJ_EFFECT_MODE:
        SACM_VC3_DJEffect(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;

      case VC3_VM_VIBRATION_MODE:
        SACM_VC3_Vibration(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;

      case VC3_VM_JET_PLANE_MODE:
        SACM_VC3_JetPlaneEffect(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;

      case VC3_VM_DOUBLING_MODE:
        SACM_VC3_Doubling(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;

      case VC3_VM_UNDERWATER_MODE:
        SACM_VC3_UnderWater(DstBufAddr, DstBufAddr, VC3_FRAME_SIZE);
        break;
