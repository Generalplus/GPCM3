...
{		
	...
	//int16_t AdcInBuf[2 * VC3_FRAME_SIZE];
	//int16_t DacOutBuf[2 * VC3_FRAME_SIZE];	
	int16_t *AdcInBuf;
	int16_t *DacOutBuf;	
...
void SACM_VC3_Initial(SACM_VC3_API_WORKING_RAM *Vc3ApiWorkingRam, int16_t *Vc3PcmBufPtr);
