...
TIMER_TYPE_DEF *mA3400ProCh4DacTimerHandle;
DMA_TYPE_DEF *mA3400ProCh4DacCh0DmaHandle;
DMA_TYPE_DEF *mA3400ProCh4DacCh1DmaHandle;
 ...
 *   None.
 */
int16_t* GetA3400ProCh4StartAddr(uint16_t SpeechIdx)
{
 ...
 *   None.
 */
void A3400Pro_CH4_CB_Init(const SACM_A3400PRO_WORKING_RAM *A3400ProWorkingRam)
{
	mA3400ProCh4DacCh0DmaHandle = DMA3;
	mA3400ProCh4DacCh1DmaHandle = DMA4;
	mA3400ProCh4DacTimerHandle = TM0;
 ...
 *   None.
 */
void A3400Pro_CH4_CB_StartPlay(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam)
{
}
 ...
 * @brief
 *   Callback function. To be implemented by user.
 *   When user call API function SACM_A3400Pro_Play_Con, this function is called by A3400Pro_CH4 Library.
 * @param
 *  *A3400ProCh4WorkingRam [in]: A3400Pro_CH4 library working RAM address.
 * @return
 *   None.
 */
void A3400Pro_CH4_CB_StartPlay_Con(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam)
{
 ...
 *   None.
 */
void A3400Pro_CH4_CB_StopPlay(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam)
{
 ...
 * @brief
 *   Callback function. Implemented by user.
 *   When user call API function SACM_A3400Pro_CH4_Pause, this function is called by A3400Pro Library.
 * @param
 *  *A3400ProWorkingRam [in]: A3400Pro library working RAM address.
 * @return
 *   None.
 */
void A3400Pro_CH4_CB_Pause(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam)
{
}
 ...
 *   None.
 */
void A3400Pro_CH4_CB_Resume(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam)
{
}
 ...
 *   None.
 */
void A3400Pro_CH4_CB_GetData(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam, uint8_t *DstBufAddr, uint8_t *SrcDataAddr, uint16_t DataLen)
{
	uint32_t iCount;
 ...
 *   None.
 */
void A3400Pro_CH4_CB_SendDac_DmaIsr(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam, int16_t *SrcBufAddr, uint16_t DataLen)
{
}
 ...
 *   None.
 */
void A3400Pro_CH4_CB_DecodeProcess(const SACM_A3400PRO_WORKING_RAM *A3400ProCh4WorkingRam, int16_t *DstBufAddr, int16_t *SrcBufAddr)
{
  SACM_A3400Pro_CH4_DecodeProcess(DstBufAddr, SrcBufAddr);
}
