...
extern uint16_t mA3400ProCh3Status;
extern uint16_t mA3400ProCh4Status;
extern SACM_A3400PRO_WORKING_RAM A3400ProWorkingRam;
extern SACM_A3400PRO_WORKING_RAM A3400ProCh2WorkingRam;
extern SACM_A3400PRO_WORKING_RAM A3400ProCh3WorkingRam;
extern SACM_A3400PRO_WORKING_RAM A3400ProCh4WorkingRam;
...
void MIXER_Ch0_CB_VoiceProcess(const SACM_MIXER_CH0_WORKING_RAM *MixerCh0WorkingRam, int16_t *DstBufAddr, int8_t *SrcBufAddr)
{
  ...
  int16_t A3400ProBuffer2[MIXER_CH0_FRAME_SIZE];
  ...
  */
  ...
  if(((SACM_A3400Pro_GetStatus() & A3400PRO_PLAY_FLAG) != 0) && (SACM_A3400Pro_GetStatus() & A3400PRO_PAUSE_FLAG) == 0)
    ...
    else
    {
      ...
      SwMixerCh1Ptr = &A3400ProBuffer[0];
    ...
    else
    {
      ...
      A3400ProCh2WorkingRam.A3400ProDecodeBufPtr = &A3400ProBuffer2[0];
      SACM_A3400Pro_CH2_ServiceLoop();

      SwMixerCh2Ptr = &A3400ProBuffer2[0];
	...
	APP_SwMixer_2ch(SwMixerCh1Ptr, SwMixerCh2Ptr, DstBufAddr, MIXER_CH0_FRAME_SIZE);

	// For A34Pro Ch3 decode process
	if(((SACM_A3400Pro_CH3_GetStatus() & A3400PRO_PLAY_FLAG) != 0) && ((SACM_A3400Pro_CH3_GetStatus() & A3400PRO_PAUSE_FLAG) == 0))
	{
    if((SACM_A3400Pro_CH3_GetStatus() & A3400PRO_DECODE_END_FLAG) != 0)
    {
      SACM_A3400Pro_CH3_Stop();
      mA3400ProCh3Status = 0;
      SwMixerCh3Ptr = 0x0000;
    }
    else
    {
      mA3400ProCh3Status |= MIXER_CH0_DECODE_WORK_FLAG;
      A3400ProCh3WorkingRam.A3400ProDecodeBufPtr = &A3400ProBuffer[0];
      SACM_A3400Pro_CH3_ServiceLoop();

      SwMixerCh3Ptr = &A3400ProBuffer[0];
	...
	// For A34Pro Ch4 decode process
	if(((SACM_A3400Pro_CH4_GetStatus() & A3400PRO_PLAY_FLAG) != 0) && ((SACM_A3400Pro_CH4_GetStatus() & A3400PRO_PAUSE_FLAG) == 0))
	{
    if((SACM_A3400Pro_CH4_GetStatus() & A3400PRO_DECODE_END_FLAG) != 0)
    {
      SACM_A3400Pro_CH4_Stop();
      mA3400ProCh4Status = 0;
      SwMixerCh4Ptr = 0x0000;
    }
    else
    {
      mA3400ProCh4Status |= MIXER_CH0_DECODE_WORK_FLAG;
      A3400ProCh4WorkingRam.A3400ProDecodeBufPtr = &A3400ProBuffer2[0];
      SACM_A3400Pro_CH4_ServiceLoop();

      SwMixerCh4Ptr = &A3400ProBuffer2[0];
  ...
  APP_SwMixer_2ch(SwMixerCh3Ptr, SwMixerCh4Ptr, A3400ProBuffer2, MIXER_CH0_FRAME_SIZE);

  SwMixerCh1Ptr = &DstBufAddr[0];
  SwMixerCh2Ptr = &A3400ProBuffer2[0];
  APP_SwMixer_2ch(SwMixerCh1Ptr, SwMixerCh2Ptr, DstBufAddr, MIXER_CH0_FRAME_SIZE);
  // APP_SwMixer_3ch(SwMixerCh1Ptr, SwMixerCh2Ptr, SwMixerCh3Ptr, DstBufAddr, MIXER_CH0_FRAME_SIZE);
}
