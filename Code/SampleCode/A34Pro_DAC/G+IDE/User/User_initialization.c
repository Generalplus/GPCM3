...
void User_Initialization()
{
    ...
    BootCode_SPIFC_SetClkDiv(SPIFC_CLKSEL_HCLK_DIV2);
...
void BootCode_SystemInit(void)
{
    ...
    MODIFY_REG(ACU->REG33_CTRL, ACU_REG33_CTRL_SLEEP_EN_MSK, ACU_REG33_CTRL_SLEEP_EN_DISABLE);  // REG33 always in normal mode
