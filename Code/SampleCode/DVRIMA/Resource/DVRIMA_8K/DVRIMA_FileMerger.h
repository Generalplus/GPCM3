...
#define _DUCK                          0       	//File  Index:0           File  Name:duck.bin 
#define _DUCK_ADDR                     (SEC_START_ADDR + 0x000030)	//File  Addr :0x000030    File  Name:duck.bin 
#define _F2                            1       	//File  Index:1           File  Name:f2.bin 
#define _F2_ADDR                       (SEC_START_ADDR + 0x003a25)	//File  Addr :0x003a25    File  Name:f2.bin 
